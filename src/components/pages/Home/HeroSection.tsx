...
const HeroSection: React.FC = () => {
  return (
    <section className="w-full bg-white pt-24 sm:pt-32 pb-16">
      <div className="w-full max-w-screen-xl mx-auto flex flex-col-reverse md:flex-row items-center gap-10 px-4">

        {/* Left: Text Content */}
        <div className="flex-1 text-center md:text-left">
          <h1
            className="
              font-mainlux font-normal text-black leading-tight
